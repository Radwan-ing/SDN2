...
export default function BankAccountsFooter({ shopConfig, currentOutput }: { shopConfig?: ShopConfig | any, currentOutput?: any }) {
  ...
  return (
    <div className="w-full mt-3 text-[10px] font-cairo flex items-center justify-between gap-2 border-t border-gray-300 pt-2.5 pb-3 whitespace-nowrap overflow-visible">
      <div className="flex flex-row items-center gap-x-2 flex-grow min-w-0 overflow-visible py-0.5">
        {shopConfig?.bankHolderName && (
      ...
      {currentOutput && (
        <div className="flex items-center gap-3.5 mr-4 shrink-0 text-[10px] border-r border-gray-300 pr-4 py-0.5 overflow-visible">
          <span className="font-mono font-bold text-gray-900 leading-none align-middle" dir="ltr">
