...
export default function AccountingInputs() {
  const [subTab, setSubTab] = useState<'types' | 'funds' | 'currencies' | 'methods'>('types');
    ...
    <div className="bg-[#141414] border border-white/5 rounded-3xl p-4 sm:p-6 w-full text-right" dir="rtl">
      ...
      <div className="flex flex-wrap gap-2 mb-6 border-b border-white/5 pb-4">
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold font-cairo transition-all flex items-center gap-2 ${subTab === 'types' ? 'bg-amber-500 text-black shadow-lg shadow-amber-500/20' : 'bg-white/5 text-gray-400 hover:text-white hover:bg-white/10'}`}
        >
          <Activity size={16} />
        ...
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold font-cairo transition-all flex items-center gap-2 ${subTab === 'funds' ? 'bg-amber-500 text-black shadow-lg shadow-amber-500/20' : 'bg-white/5 text-gray-400 hover:text-white hover:bg-white/10'}`}
        >
          <Wallet size={16} />
          إدارة الصناديق
        </button>
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold font-cairo transition-all flex items-center gap-2 ${subTab === 'currencies' ? 'bg-amber-500 text-black shadow-lg shadow-amber-500/20' : 'bg-white/5 text-gray-400 hover:text-white hover:bg-white/10'}`}
        >
          <Coins size={16} />
          إدارة العملات
        </button>
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold font-cairo transition-all flex items-center gap-2 ${subTab === 'methods' ? 'bg-amber-500 text-black shadow-lg shadow-amber-500/20' : 'bg-white/5 text-gray-400 hover:text-white hover:bg-white/10'}`}
        >
          <CreditCard size={16} />
          إدارة طرق الدفع
        </button>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        onChange={(e) => setFundForm({ ...fundForm, bankAccount: e.target.value })}
